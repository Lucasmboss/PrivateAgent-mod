...
class _SettingsScreenState extends State<SettingsScreen>
  ...
  bool _googleVoiceAvailable = false;
  ...
  Future<void> _checkAssistantStatus() async {
    ...
    final googleVoice = await AssistantPlatformService.isGoogleVoiceAvailable();
    if (!mounted) return;
    setState(() {
      _isDefaultAssistant = isDefault;
      _googleVoiceAvailable = googleVoice;
    });
  }
        ...
        children: [
          ...
          _buildSettingsCard(
            ...
            children: [
              ...
              Text(
                _googleVoiceAvailable
                    ? 'Google Speech Services detected. Voice input and output use the native Google engines when available.'
                    : 'Google Speech Services were not detected. The app will use its compatibility fallback until they are installed.',
                style: TextStyle(
                  fontSize: 12,
                  color: _googleVoiceAvailable
                      ? Colors.green[700]
                      : Colors.orange[800],
                ),
              ),
